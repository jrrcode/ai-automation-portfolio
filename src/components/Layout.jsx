...
export function Layout({ children }) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 mx-auto grid min-h-screen w-full max-w-7xl grid-cols-1 px-6 py-8 sm:px-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20 lg:px-16 lg:py-0">
